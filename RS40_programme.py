...
#mon n = p*q fait 513 digits, donc -> 1704 bits = 1704/8 = 213 octets
#
#
def mot256char(x1, x2): #entrer le secret
#fonction pour trouver 213 avec x1 et x2
    secret=input("donner un secret de 213 caractères au maximum : ")
    while (len(secret)>214):
        secret=input("c'est beaucoup trop long, 213 caractères S.V.P : ")
    return(secret)
...
dechif=home_int_to_string(home_crt(chif, da, na, x1a, x2a))#######################a changer home_crt
print(dechif)
print("*******************************************************************")
